...
class BusinessFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'business_ibfk_1' => ['type' => 'foreign', 'columns' => ['business_category_id'], 'references' => ['business_categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'business_ibfk_2' => ['type' => 'foreign', 'columns' => ['city_id'], 'references' => ['cities', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
