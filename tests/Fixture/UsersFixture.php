...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['busines_id'], 'references' => ['business', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'role' => 1,
            'created' => '2016-03-07 17:33:58',
            'updated' => '2016-03-07 17:33:58'
        ],
    ];
}
